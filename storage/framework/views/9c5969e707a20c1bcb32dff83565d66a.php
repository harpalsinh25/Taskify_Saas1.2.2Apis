...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme menu-container">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item <?php echo e(Request::is($prefix . '/customers') || Request::is($prefix . '/customers/*') ? 'active' : ''); ?>">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text"><?= get_label('subscription_management', 'Subscription Management') ?></span>
        </li>
        <li class="menu-item <?php echo e(Request::is($prefix . '/plans') || Request::is($prefix . '/plans/*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('plans.index')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-task "></i>
                <div><?= get_label('plans', 'Plans') ?></div>
            </a>
        </li>
        <li class="menu-item <?php echo e(Request::is($prefix . '/subscriptions') || Request::is($prefix . '/subscriptions/*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is($prefix . '/transactions') || Request::is($prefix . '/transactions/*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is($prefix . '/managers') || Request::is($prefix . '/managers/*') ? 'active' : ''); ?>">
        ...
        <li class="menu-item <?php echo e(Request::is($prefix . '/settings') || Request::is($prefix . '/roles/*') || Request::is($prefix . '/settings/*') ? 'active open' : ''); ?>">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item <?php echo e(Request::is($prefix . '/settings/permission') || Request::is('roles/*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('roles.index')); ?>" class="menu-link">
                        <div><?= get_label('permissions', 'Permissions') ?></div>
                    </a>
                </li>
                <li class="menu-item <?php echo e(Request::is($prefix . '/settings/languages') || Request::is($prefix . '/settings/languages/create') ? 'active' : ''); ?>">
                ...
                <li class="menu-item <?php echo e(Request::is($prefix . '/settings/terms-and-conditions') ? 'active' : ''); ?>">
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme menu-container">
    ...
    <ul class="menu-inner pb-1">
        ...
        <li class="<?php echo e($menu['class']); ?>">
            <a href="<?php echo e($menu['url'] ?? 'javascript:void(0)'); ?>" class="menu-link <?php echo e(isset($menu['submenus']) ? 'menu-toggle' : ''); ?>">
...
<?php endif; ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\Code v1.2.1 upload this on server\resources\views/components/menu.blade.php ENDPATH**/ ?>