    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <?php echo e(get_label('client_permissions', 'Client Permissions')); ?> - <?php echo e($client->first_name); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="table-responsive text-nowrap">
                        <form id = "ClientPermissions" method = "POST"
                            action= "<?php echo e(route('clients.update_permissions', ['client' => $client->id])); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/clients/permissions.blade.php ENDPATH**/ ?>