    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb-2 mt-4">
            ...
            <div>
                ...
                <a href="<?php echo e(route('contracts.contract_types')); ?>"><button type="button" class="btn btn-sm btn-primary"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <table id="contracts_table" data-toggle="table" data-loading-template="loadingTemplate"
                            data-url="<?php echo e(route('contracts.list')); ?>" data-icons-prefix="bx" data-icons="icons" data-show-refresh="true"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="client"
                                        data-visible="<?php echo e(in_array('client', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>"
                                        data-sortable="false"><?= get_label('client', 'Client') ?></th>
                                    <th data-field="project"
                                        data-visible="<?php echo e(in_array('project', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>"
                                        data-sortable="false"><?= get_label('project', 'Project') ?></th>
                                    <th data-field="contract_type"
                                        data-visible="<?php echo e(in_array('contract_type', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>"
                                    ...
                                    <th data-field="duration"
                                        data-visible="<?php echo e(in_array('duration', $visibleColumns) ? 'true' : 'false'); ?>"
                                        data-sortable="false"><?= get_label('duration', 'Duration') ?></th>
                                    <th data-field="value"
                                        data-visible="<?php echo e(in_array('value', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>"
                                        data-sortable="true"><?= get_label('value', 'Value') ?></th>
                                    <th data-field="promisor_sign"
                                        data-visible="<?php echo e(in_array('promisor_sign', $visibleColumns) ? 'true' : 'false'); ?>"
                                        data-sortable="true">
                                        <?= get_label('promisor_sign_status', 'Promisor sign status') ?></th>
                                    <th data-field="promisee_sign"
                                        data-visible="<?php echo e(in_array('promisee_sign', $visibleColumns) ? 'true' : 'false'); ?>"
                                        data-sortable="true">
...
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/contracts.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/contracts/list.blade.php ENDPATH**/ ?>