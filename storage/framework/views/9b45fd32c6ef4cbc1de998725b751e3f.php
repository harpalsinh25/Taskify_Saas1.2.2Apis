                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        <li class="breadcrumb-item">
                          ...
                          <li class="breadcrumb-item">
                            <a href="<?php echo e(route('plans.index')); ?>"><?= get_label('plans', 'Plans') ?></a>
                        </li>
                    ...
                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <div class="col">
                                                <label for="yearlyPrice"
                                                    class="form-label"><?= get_label('price', 'Price:') ?></label>
                                                <input type="number" class="form-control tenure-price min_0"
                                                    id="yearly_price" min="0" required>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <div class="col">
                                                <label for="lifetimePrice"
                                                    class="form-label"><?= get_label('price', 'Price:') ?></label>
                                                <input type="number" class="form-control tenure-price min_0"
                                                    id="lifetime_price" min="0" required>
                                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                               ...
                               <div class="row mb-3">
    <div class="col-md-12">
        <label class="form-label mb-2 me-4"><?php echo e(get_label('status', 'Status')); ?></label>
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
            <input type="radio" class="btn-check" name="status" id="active" value="active" checked>
            <label class="btn btn-outline-primary" for="active"><?php echo e(get_label('active', 'Active')); ?></label>

            <input type="radio" class="btn-check" name="status" id="inactive" value="inactive">
            <label class="btn btn-outline-primary" for="inactive"><?php echo e(get_label('inactive', 'Inactive')); ?></label>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    <div class="col-md-12">
        <label for="planImage" class="form-label bold">
            <?php echo e(get_label('plan_image', 'Plan Image')); ?><span class="asterisk">*</span>
        </label>
        <input type="file" class="form-control mt-2" id="planImage" name="plan_image" accept="image/*" required>
    </div>
</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\Code v1.2.1 upload this on server\resources\views/superadmin/plans/create.blade.php ENDPATH**/ ?>