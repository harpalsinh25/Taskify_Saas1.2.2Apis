            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-7 d-flex justify-content-center flex-column">
                        <h1 class="text-gradient text-primary"> <?php echo e($general_settings['company_title']); ?></h1>
                        <h1 class="mb-4"></h1>
                        <p class="lead pe-2">
                        ...
                        <div class="buttons">
                            <a href="<?php echo e(route('login')); ?>"
                                class="btn bg-gradient-primary mt-4"><?php echo e(get_label('get_started', 'Get Started')); ?></a>
                            <a href="<?php echo e(route('frontend.contact_us')); ?>"
                                class="btn text-primary mt-4 shadow-none"><?php echo e(get_label('contact_us', 'Contact Us')); ?></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-7 d-flex justify-content-center flex-column">
                        <div class="img-fluid">
            ...
            <div class="row align-items-center">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <h5><?php echo e(get_label('streamline_projects', 'Streamline Your Projects with')); ?>

                                    <?php echo e($general_settings['company_title']); ?></h5>
                                <p> <?php echo e(get_label(
                        ...
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <h5><?php echo e(get_label('effortless_organization', 'Effortless Organization')); ?></h5>
                                <p><?php echo e($general_settings['company_title']); ?>
                    ...
                    <div class="row justify-content-start">
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <h5><?php echo e(get_label('seamless_collaboration', 'Seamless Collaboration')); ?></h5>
                                <p> <?php echo e(get_label(
                        ...
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <h5><?php echo e(get_label('visualize_project_health', 'Visualize Project Health')); ?></h5>
                                <p><?php echo e(get_label(
                ...
                <div class="col-lg-3 ms-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4>
                                <?php echo e(get_label('team_collaboration', 'Team Collaboration')); ?>
                            ...
                            <a href="<?php echo e(route('frontend.features')); ?>" class="text-primary icon-move-right">
                                <?php echo e(get_label('learn_more', 'Learn More.')); ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h3 class="text-gradient text-primary mb-0 mt-2">
                        <?php echo e(get_label('read_more_about_us', 'Read More About Us')); ?></h3>
                    <h3><?php echo e(get_label('maximizing_efficiency', 'Maximizing Efficiency')); ?></h3>
                    <p><?php echo e(get_label(
                        'maxEffiencyDesc',
                    ...
                    <a href="<?php echo e(route('frontend.about_us')); ?>"
                        class="text-primary icon-move-right"><?php echo e(get_label('read_more_about_us', 'Read more About Us')); ?>
                ...
                <div class="col-lg-6 mt-lg-0 ps-lg-0 mt-5 ps-0">
                    <div class="info-horizontal p-3">
                        <div class="icon icon-shape rounded-circle text-center shadow">
                            <img src="<?php echo e(asset('assets/front-end/img/icons/project-management.png')); ?>" class="icon-size"
                    ...
                    <div class="info-horizontal p-3">
                        <div class="icon icon-shape rounded-circle text-center shadow">
                            <img src="<?php echo e(asset('assets/front-end/img/icons/task-tracking.png')); ?>" class="icon-size"
                                alt="<?php echo e(get_label('task_tracking', 'Task Tracking')); ?>">
                        </div>
                        <div class=" ps-3">
                            <p class="mb-0 ms-5">
                                <?php echo e(get_label(
                ...
                <div class="pb-lg-9 postion-relative z-index-2 container pb-8 pt-7">
                    <div class="row z-index-frontend mb-5">
                        <div class="col-md-8 mx-auto text-center">
                            <span class="badge bg-gradient-dark mb-2"><?php echo e(get_label('pricing', 'Pricing')); ?></span>
                            <h3 class="text-white"><?php echo e(get_label('see_our_pricing', 'See our pricing')); ?></h3>
                            <p class="text-white">
                                <?php echo e(get_label(
                                    'seePricingDesc',
                                ...
                                <a href="<?php echo e(route('frontend.pricing')); ?>"
                                    class="small icon-move-right"><?php echo e(get_label('explore_more_plans', 'Explore More Plans')); ?>
                                    ...
                                    <ul class="nav nav-pills nav-fill position-relative flex-row p-1" id="tabs-pricing-4"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active mb-0" id="tabs-iconpricing-tab-1"
                                                ...
                                                <?php echo e(get_label('monthly', 'Monthly')); ?>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mb-0" id="tabs-iconpricing-tab-2" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">
                                                <?php echo e(get_label('annual', 'Annual')); ?>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mb-0" id="tabs-iconpricing-tab-3" data-bs-toggle="tab"
                                                ...
                                                aria-selected="false">
                                                <?php echo e(get_label('lifetime', 'Lifetime')); ?>
                                                ...
                                                <div class="card-header text-sm-start px-4 pb-3 pt-4 text-center">
                                                    ...
                                                    <h3 class="font-weight-bolder mt-3">
                                                        <small class="text-secondary font-weight-bold">
                                                            <?php if($plan->monthly_discounted_price > 0 && $plan->monthly_discounted_price < $plan->monthly_price): ?>
                                                                <strike><?php echo e(format_currency($plan->monthly_price)); ?></strike>
                                                        </small>
                                                        <?php echo e(format_currency($plan->monthly_discounted_price)); ?> <small
                                                            class="text-secondary font-weight-bold text-sm">/
                                                            <?php echo e(get_label('monthly_price', 'Monthly Price')); ?></small>
                                                    <?php else: ?>
                                                        <?php echo e(format_currency($plan->monthly_price)); ?> <small
                                                            class="text-secondary font-weight-bold text-sm">/
                                                            <?php echo e(get_label('monthly_price', 'Monthly Price')); ?>

                                                        </small>
                                    <?php endif; ?>
                                    </small>
                                    </h3>
                                    <p class="text-lighter small text-black-50"><?php echo e($plan->description); ?></p>
                                    <?php if($plan->monthly_price == 0): ?>
                                        <a href="<?php echo e(route('login')); ?>"
                                            class="btn btn-outline-primary btn-sm w-100 border-radius-md mb-2 mt-4 text-center"><?php echo e(get_label('buy_now', 'Buy now')); ?></a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>"
                                            class="btn btn-sm bg-gradient-dark w-100 border-radius-md mb-2 mt-4 text-center"><?php echo e(get_label('buy_now', 'Buy now')); ?></a>
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="justify-content-start d-flex px-2 py-1">
                                        <ul class="list-unstyled mb-4">
                                            <li class="mb-2">
                                                ...
                                                <span
                                                    class="fw-semibold"><?php echo e(get_label('max_projects', 'Max Projects')); ?>:</span>
                                            ...
                                            <li class="mb-2">
                                                <i class="fas fa-check-circle text-primary text-gradient me-2"></i>
                                                <span
                                                    class="fw-semibold"><?php echo e(get_label('max_clients', 'Max Clients')); ?>:</span>
                                            ...
                                            <li class="mb-2">
                                                <i class="fas fa-check-circle text-primary text-gradient me-2"></i>
                                                <span
                                                    class="fw-semibold"><?php echo e(get_label(
                                                        'max_team_members',
                                                        'Max Team
                                                                        Members',
                                                    )); ?>:</span>
                                            ...
                                            <?php if($plan->modules): ?>
                                                <li class="mb-2">
                                                    <i class="fas fa-check-circle text-primary text-gradient me-2"></i>
                                                    <span class="fw-semibold"><?php echo e(get_label('modules', 'Modules')); ?></span>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6 mb-lg-0 mb-4 gap-2 pb-3">
                            <div class="card shadow-lg">
                                <div class="card-header text-sm-start px-4 pb-3 pt-4 text-center">
                                    ...
                                    <h3 class="font-weight-bolder mt-3">
                                        <small class="text-secondary font-weight-bold">
                                            <?php if($plan->yearly_discounted_price > 0 && $plan->yearly_discounted_price < $plan->yearly_price): ?>
                                                <strike><?php echo e(format_currency($plan->yearly_price)); ?></strike>
                                        </small>
                                        <?php echo e(format_currency($plan->yearly_discounted_price)); ?> <small
                                            class="text-secondary font-weight-bold text-sm">/
                                            <?php echo e(get_label('yearly_price', 'Yearly Price')); ?></small>
                                    <?php else: ?>
                                        <?php echo e(format_currency($plan->yearly_price)); ?> <small
                                            class="text-secondary font-weight-bold text-sm">/
                                            <?php echo e(get_label('yearly_price', 'Yearly Price')); ?>
                ...
                <div class="card-body pt-0">
                    <div class="justify-content-start d-flex px-2 py-1">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-primary text-gradient me-2"></i>
                                <span class="fw-semibold"><?php echo e(get_label('max_projects', 'Max Projects')); ?>:</span>
                                <?php echo $plan->max_projects == -1
                                    ? '<span class="fw-semibold">Unlimited</span>'
                                    : '<span class="fw-semibold">' . $plan->max_projects . '</span>'; ?>
                            ...
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-primary text-gradient me-2"></i>
                                <span class="fw-semibold"><?php echo e(get_label('max_clients', 'Max Clients')); ?>:</span>
                                <?php echo $plan->max_clients == -1
                                    ? '<span class="fw-semibold">Unlimited</span>'
                                    : '<span class="fw-semibold">' . $plan->max_clients . '</span>'; ?>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 mb-lg-0 mb-4 gap-2 pb-3">
                    <div class="card shadow-lg">
                        <div class="card-header text-sm-start px-4 pb-3 pt-4 text-center">
                            ...
                            <h3 class="font-weight-bolder mt-3">
                                <small class="text-secondary font-weight-bold">
                                    <?php if($plan->lifetime_discounted_price > 0 && $plan->lifetime_discounted_price < $plan->lifetime_price): ?>
                                        <strike><?php echo e(format_currency($plan->lifetime_price)); ?></strike>
                                </small>
                                <?php echo e(format_currency($plan->lifetime_discounted_price)); ?> <small
                                    class="text-secondary font-weight-bold text-sm">/
                                    <?php echo e(get_label('lifetime_price', 'Lifetime Price')); ?></small>
                            <?php else: ?>
                                <?php echo e(format_currency($plan->lifetime_price)); ?> <small
                                    class="text-secondary font-weight-bold text-sm">/
                                    <?php echo e(get_label('lifetime_price', 'Lifetime Price')); ?>
    ...
    <div class="container mb-8 mt-8 py-3">
        <div class="alert bg-gradient-warning h4 text-center">
            <i class="fas fa-exclamation-circle"></i> <span class="text-black">
                <?php echo e(get_label('no_plans_available', 'No Plans Available')); ?></span>
        </div>
    </div>
    <?php endif; ?>
    </section>
        ...
        <div class="container">
            <div class="row my-5">
                <div class="col-md-6 mx-auto text-center">
                    <h2><?php echo e(get_label('frequently_asked_questions', 'Frequently Asked Questions')); ?>
...
<?php echo $__env->make('front-end.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\Code v1.2.1 upload this on server\resources\views/front-end/index.blade.php ENDPATH**/ ?>