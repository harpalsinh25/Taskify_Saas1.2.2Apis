<div class="card">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <?php if(is_countable($priorities) && count($priorities) > 0): ?>
            <input type="hidden" id="data_type" value="priority">
            <table id="table" data-toggle="table" data-loading-template="loadingTemplate" data-url="<?php echo e(route('priority.list')); ?>" data-icons-prefix="bx" data-icons="icons" data-show-refresh="true" data-total-field="total" data-trim-on-search="false" data-data-field="rows" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-side-pagination="server" data-show-columns="true" data-pagination="true" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-query-params="queryParams">
                <thead>
                    <tr>
...
<?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/components/priority-card.blade.php ENDPATH**/ ?>