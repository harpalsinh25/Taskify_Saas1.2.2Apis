...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mt-4">
            ...
            <a href="<?php echo e(route('activity_log.calendar_view')); ?>"><button type="button" class="btn btn-sm btn-primary"
                        ...
                        <div class="mb-3 col-md-3">
                            <select class="form-select" id="type_filter" aria-label="Default select example">
                                ...
                                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type); ?>"><?php echo e(Str::title(str_replace('_', ' ', $type))); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/activity-log.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/activity_log/list.blade.php ENDPATH**/ ?>