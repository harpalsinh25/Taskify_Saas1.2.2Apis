...
<?php $__env->startSection('title'); ?>
    <?php echo e(get_label('lead_stages', 'Lead Stages')); ?>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="alert alert-primary d-flex align-items-center">
                            ...
                            <span class="fw-semibold"><?php echo e(get_label('lead_stages_reorder_info','Drag and drop the rows below to change the order of your lead
                                stages.')); ?></span>
                        </div>
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <table id="table" data-toggle="table" data-loading-template="loadingTemplate"
                            data-url="<?php echo e(route('lead-stages.list')); ?>" data-icons-prefix="bx" data-icons="icons"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="preview"
                                        data-visible="<?php echo e(in_array('preview', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>"
...
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/lead_stages.js')); ?>"></script>
  
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/lead_stages/index.blade.php ENDPATH**/ ?>