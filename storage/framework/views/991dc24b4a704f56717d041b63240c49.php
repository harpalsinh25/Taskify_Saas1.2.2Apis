...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item">
                            <a
                                href="<?php echo e(route('users.show', [$user->id])); ?>"><?php echo e($user->first_name . ' ' . $user->last_name); ?></a>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('users.update_user', [$user->id])); ?>" class="form-submit-event" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="last_name"
                                ...
                                id="last_name" value="<?php echo e($user->last_name); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select text-capitalize js-example-basic-multiple" id="role"
                                    name="role" <?php echo e($user->hasRole('admin') ? 'disabled' : ''); ?>>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" id="phone-input-edit"
                                    value="<?php echo e($user->phone); ?>" name="phone">
                                ...
                                <input type="hidden" name="country_iso_code" id="country_iso_code"
                                    value="<?php echo e($user->country_iso_code); ?>">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" id="dob" name="dob"
                                value="<?php echo e($user->dob ? format_date($user->dob) : ''); ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" id="doj" name="doj"
                                value="<?php echo e($user->doj ? format_date($user->doj) : ''); ?>"
                                placeholder="<?= get_label('please_select', 'Please select') ?>" autocomplete="off">
                        </div>
                        ...
                        <?php if(isAdminOrHasAllDataAccess() && $user->getRoleNames()->first() !== 'admin'): ?>
                            <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/users/edit_user.blade.php ENDPATH**/ ?>