                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select class="form-select" id="color" name="color">
                                                ...
                                                <option class="badge bg-label-info" value="info"
                                                    <?php echo e(old('color') == 'info' ? 'selected' : ''); ?>>
                                                    <?= get_label('info', 'Info') ?>
                                                </option>
                                                <option class="badge bg-label-dark" value="dark"
                                                    <?php echo e(old('color') == 'dark' ? 'selected' : ''); ?>>
                                                    <?= get_label('dark', 'Dark') ?>
                                                </option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="col-12 mb-3">
                                                <label class="form-label">
                                                    ...
                                                    <i class='bx bx-info-circle text-primary' data-bs-toggle="tooltip"
                                                        ...
                                                        data-bs-original-title="<?php echo e(get_label('roles_can_set_status_info', 'Including Admin and Roles with All Data Access Permission, Users/Clients Under Selected Role(s) Will Have Permission to Set This Status.')); ?>"></i>
                                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5 leave-to-date-div mb-3">
                            ...
                            <span class="form-text d-none"
                                id="guide_text"><?php echo e(get_label(
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="leaveVisibleToAll">
                                    <?= get_label('visible_to_all', 'Visible To All') ?>? <i
                                        ...
                                        data-bs-offset="0,4" data-bs-placement="top" title=""
                                        data-bs-html="true"
                                        data-bs-original-title="<?php echo e(get_label('leave_visible_to_info', 'Disabled: Requestee, Admin, and Leave Editors, along with selected users, will be able to know when the requestee is on leave. Enabled: All team members will be able to know when the requestee is on leave.')); ?>"></i>
                                </label>
                            </div>
                        </div>
...
<?php if(Request::is($prefix . '/contracts')): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="<?php echo e(route('contracts.contract_types')); ?>"><button type="button"
    ...
    <div class="modal fade" id="edit_contract_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form class="modal-content form-submit-event" action="<?php echo e(route('contracts.update')); ?>"
                method="POST">
                <input type="hidden" name="dnr">
                <input type="hidden" name="table" value="contracts_table">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <select class="form-control" id="time_tracker_project" name="project">
                                ...
                                <?php $__currentLoopData = $TimeTrackerProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade" id="permission_instuction_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul>
                    <li class="mb-2"><b><?php echo e(get_label('all_data_access', 'All Data Access')); ?>:</b> If this option
                    ...
                    <li class="mb-2"><b><?php echo e(get_label('allocated_data_access', 'Allocated Data Access')); ?>:</b> If
                    ...
                    <li class="mb-2"><b><?php echo e(get_label('create_permission', 'Create Permission')); ?>:</b> This
                    ...
                    <li class="mb-2"><b><?php echo e(get_label('manage_permission', 'Manage Permission')); ?>:</b> This
                    ...
                    <li class="mb-2"><b><?php echo e(get_label('edit_permission', 'Edit Permission')); ?>:</b> This determines
                    ...
                    <li><b><?php echo e(get_label('delete_permission', 'Delete Permission')); ?>:</b> This determines whether
                                ...
                                <?php if(isset($invoices)): ?>
                                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($invoice->id); ?>">
                                            <?php echo e(get_label('invoice_id_prefix', 'INVC-') . $invoice->id); ?>
                    ...
                    <div class="modal fade" id="create_project_modal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <form action="<?php echo e(route('projects.store')); ?>" class="form-submit-event modal-content" method="POST">
                                <?php if(!Request::is($prefix . '/projects') && !Request::is($prefix . '/projects/kanban-view')): ?>
                                    <input type="hidden" name="dnr">
                                                        ...
                                                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(canSetStatus($status)): ?>
                                                                <option value="<?php echo e($status->id); ?>"
                                                                    ...
                                                                    <?php echo e($status->title); ?> (<?php echo e($status->color); ?>)
                                                                </option>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <?php if(isset($toSelectProjectUsers)): ?>
                                                        <?php $__currentLoopData = $toSelectProjectUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <option value="<?php echo e($user->id); ?>"
                                                                ...
                                                                <?= $selected ?>><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-fields','data' => ['isEdit' => $isEdit,'fields' => $projectCustomFields]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="task_list_id" id="task_list"
                                                data-placeholder="<?php echo e(get_label('select_task_list', 'Select Task List')); ?> ">
                                                <option value=""><?php echo e(get_label('select_task_list', 'Select Task List')); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="billing_type" id="billing_type">
                                                <option value="none"><?php echo e(get_label('none', 'None')); ?></option>
                                                <option value="billable"><?php echo e(get_label('billable', 'Billable')); ?></option>
                                                <option value="non-billable"><?php echo e(get_label('non_billable', 'Non Billable')); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"
                                                for="completion_percentage"><?php echo e(get_label('completion_percentage', 'Completion Percentage (%)')); ?></label>
                                            <select class="form-select" name="completion_percentage" id="completion_percentage">
                                                <?php $__currentLoopData = range(0, 100, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $percentage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($percentage); ?>"><?php echo e($percentage); ?>%</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php $__errorArgs = ['completion_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            <label class="form-label"><?php echo e(get_label('note', 'Note')); ?></label>
                                            <textarea class="form-control" name="note" rows="3"
                                                placeholder="<?php echo e(get_label('optional_note', 'Optional Note')); ?> "></textarea>
                                        </div>

                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="reminder-switch"
                                                    class="form-label"><?php echo e(get_label('enable_reminder', 'Enable Reminder')); ?></label>
                                                <i class="bx bx-info-circle text-primary"
                                                    data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top"
                                                    data-bs-html="true" title=""
                                                    data-bs-original-title="<b><?php echo e(get_label('task_reminder', 'Task Reminder')); ?>:</b> <?php echo e(get_label('task_reminder_info', 'Enable this option to set reminders for tasks. You can configure reminder frequencies (daily, weekly, or monthly), specific times, and customize alerts to ensure you stay on track with task deadlines.')); ?>"></i>
                                                <div class="form-check form-switch">
                                                    <input type="Checkbox" class="form-check-input" id="reminder-switch"
                                                        name="enable_reminder">
                                                    <label class="form-check-label"
                                                        for="reminder-switch"><?php echo e(get_label('enable_task_reminder', 'Enable Task Reminder')); ?></label>
                                                </div>
                                            </div>
                                            <div id="reminder-settings" class="d-none">
                                                ...
                                                <div class="mb-3">
                                                    <label for="frequency-type"
                                                        class="form-label"><?php echo e(get_label('frequency_type', 'Frequency Type')); ?></label>
                                                    <select class="form-select" id="frequency-type" name="frequency_type"
                                                        required>
                                                        <option value="daily"><?php echo e(get_label('daily', 'Daily')); ?></option>
                                                        <option value="weekly"><?php echo e(get_label('weekly', 'Weekly')); ?></option>
                                                        <option value="monthly"><?php echo e(get_label('monthly', 'Monthly')); ?></option>
                                                    </select>
                                                </div>
                                                <!-- Day of Week (Weekly Only) -->
                                                <div class="d-none mb-3" id="day-of-week-group">
                                                    <label
                                                        for="day-of-week" class="form-label"><?php echo e(get_label('day_of_the_week', 'Day of the Week')); ?></label>
                                                    <select class="form-select" id="day-of-week" name="day_of_week">
                                                        <option value=""><?php echo e(get_label('any_day', 'Any Day')); ?></option>
                                                        <option value="1"><?php echo e(get_label('monday', 'Monday')); ?></option>
                                                        <option value="2"><?php echo e(get_label('tuesday', 'Tuesday')); ?></option>
                                                        <option value="3"><?php echo e(get_label('wednesday', 'Wednesday')); ?></option>
                                                        <option value="4"><?php echo e(get_label('thursday', 'Thursday')); ?></option>
                                                        <option value="5"><?php echo e(get_label('friday', 'Friday')); ?></option>
                                                        <option value="6"><?php echo e(get_label('saturday', 'Saturday')); ?></option>
                                                        <option value="7"><?php echo e(get_label('sunday', 'Sunday')); ?></option>
                                                    </select>
                                                </div>
                                                <!-- Day of Month (Monthly Only) -->
                                                <div class="d-none mb-3" id="day-of-month-group">
                                                    <label for="day-of-month"
                                                        class="form-label"><?php echo e(get_label('day_of_the_month', 'Day of the Month')); ?></label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="time-of-day"
                                                        class="form-label"><?php echo e(get_label('time_of_day', 'Time of Day')); ?></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="recurring-task-switch" class="form-label">
                                                    <?php echo e(get_label('enable_recurring_task', 'Enable Recurring Task')); ?>

                                                </label>
                                                <i class="bx bx-info-circle text-primary" data-bs-toggle="tooltip"
                                                    data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true"
                                                    title=""
                                                    data-bs-original-title="<b><?php echo e(get_label('recurring_tasks', 'Recurring Tasks')); ?>:</b> <?php echo e(get_label('recurring_tasks_info', 'This option enables the creation of recurring tasks. You can set the frequency (daily, weekly, monthly, yearly), specific days, and manage the recurrence schedule efficiently.')); ?>">
                                                </i>
                                                <div class="form-check form-switch">
                                            ...
                                            <div id="recurring-task-settings" class="d-none">
                                                ...
                                                <div class="mb-3">
                                                    <label for="recurrence-frequency" class="form-label">
                                                        <?php echo e(get_label('recurrence_frequency', 'Recurrence Frequency')); ?>
                                                    ...
                                                    <select class="form-select" id="recurrence-frequency"
                                                        ...
                                                        <option value="weekly"><?php echo e(get_label('weekly', 'Weekly')); ?></option>
                                                        <option value="monthly"><?php echo e(get_label('monthly', 'Monthly')); ?></option>
                                                        <option value="yearly"><?php echo e(get_label('yearly', 'Yearly')); ?></option>
                                                    </select>
                                                </div>
                                                <!-- Day of Week (Weekly Only) -->
                                                <div class="d-none mb-3" id="recurrence-day-of-week-group">
                                                    <label for="recurrence-day-of-week" class="form-label">
                                                        <?php echo e(get_label('day_of_the_week', 'Day of the Week')); ?>
                                                ...
                                                <div class="d-none mb-3" id="recurrence-day-of-month-group">
                                                    <label for="recurrence-day-of-month" class="form-label">
                                                        <?php echo e(get_label('day_of_the_month', 'Day of the Month')); ?>
                                                ...
                                                <div class="d-none mb-3" id="recurrence-month-of-year-group">
                                                    <label for="recurrence-month-of-year" class="form-label">
                                                        <?php echo e(get_label('month_of_the_year', 'Month of the Year')); ?>

                                                    </label>
                                                    <select class="form-select" id="recurrence-month-of-year"
                                                        name="recurrence_month_of_year">
                                                        <option value=""><?php echo e(get_label('any_month', 'Any Month')); ?></option>
                                                ...
                                                <div class="mb-3">
                                                    <label for="recurrence-starts-from" class="form-label">
                                                        <?php echo e(get_label('starts_from', 'Starts From')); ?>
                                                ...
                                                <div class="mb-3">
                                                    <label for="recurrence-occurrences" class="form-label">
                                                        <?php echo e(get_label('number_of_occurrences', 'Number of Occurrences')); ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal08fb32409d907753af2039acaeea58af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal08fb32409d907753af2039acaeea58af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-fields','data' => ['isEdit' => $isEdit,'fields' => $taskCustomFields]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('custom-fields'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['isEdit' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isEdit),'fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($taskCustomFields)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal08fb32409d907753af2039acaeea58af)): ?>
<?php $attributes = $__attributesOriginal08fb32409d907753af2039acaeea58af; ?>
...
<?php endif; ?>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="submit_btn"
                                        class="btn btn-primary"><?php echo e(get_label('create', 'Create')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
                                            ...
                                            <div id="edit-reminder-settings" class="d-none">
                                                ...
                                                <div class="d-none mb-3" id="edit-day-of-week-group">
                                                    <label for="day-of-week"
                                                        class="form-label"><?php echo e(get_label('day_of_the_week', 'Day of the Week')); ?></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="recurring-task-switch">
                                                        <?php echo e(get_label('enable_recurring_task_toggle', 'Enable Recurring Task')); ?>
                                                ...
                                                <div class="tab-pane fade active show" id="navs-top-quick-view-users"
                                                    ...
                                                    <div class="table-responsive text-nowrap">
                                                        ...
                                                        <table id="usersTable" data-toggle="table"
                                                            ...
                                                            data-url="<?php echo e(route('users.list')); ?>" data-icons-prefix="bx"
                                                ...
                                                <div class="tab-pane fade <?php echo e(!$auth_user->can('manage_users') ? 'active show' : ''); ?>"
                                                    ...
                                                    <input type="hidden" id="data_table" value="clientsTable"> -->
                                                        <table id="clientsTable" data-toggle="table"
                                                            data-loading-template="loadingTemplate"
                                                            data-url="<?php echo e(route('clients.list')); ?>" data-icons-prefix="bx"
                                                            data-icons="icons" data-show-refresh="true" data-total-field="total"
                                                            data-trim-on-search="false" data-data-field="rows"
                                                            data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                                                            data-side-pagination="server" data-show-columns="true"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="mb-3">
                            <label for="clients" class="form-label"><?php echo e(get_label('clients', 'Clients')); ?></label>
                            <select id="" class="form-control js-example-basic-multiple"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="mb-3">
                            <label for="users" class="form-label"><?php echo e(get_label('users', 'Users')); ?></label>
                            <select id="" class="form-control js-example-basic-multiple"
                                name="user_ids[]" multiple="multiple"
                                data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                                <?php if(isset($admin)): ?>
    ...
    <?php if(isset($project)): ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="replyForm" method="POST" enctype="multipart/form-data"
                            action="<?php echo e(route('comments.store', ['id' => $project->id])); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="project-reply-content" data-mention-type="project" data-mention-id="<?php echo e($project->id); ?>"
                                    name="content" rows="4" class="form-control" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="attachments"
                                    class="form-label"><?php echo e(get_label('attachments', 'Attachments')); ?></label>
                                <input type="file" multiple name="attachments[]" id="attachments"
                                    class="form-control">
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit"
                                    class="btn btn-primary me-2"><?php echo e(get_label('submit', 'Submit')); ?></button>
        ...
        <div class="modal fade" id="commentModal" tabindex="-1" aria-labelledby="commentModalLabel"
            ...
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="commentModalLabel"><?php echo e(get_label('add_comment', 'Add Comment')); ?>
                        ...
                        <form id="comment-form" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="mb-3">
                                <textarea id="project-comment-content" name="content" rows="4" class="form-control"
                                    data-mention-type="project" data-mention-id="<?php echo e($project->id); ?>"
                                    placeholder="<?php echo e(get_label('enter_comment', 'Enter Comment')); ?>" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="attachments"
                                    class="form-label"><?php echo e(get_label('attachments', 'Attachments')); ?></label>
                            ...
                            <button type="submit" id="submit_btn"
                                class="btn btn-primary"><?php echo e(get_label(
            'post_comment',
            'Post
                                                                                                                                                                                                                                Comment',
        )); ?></button>
                            <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal"><?php echo e(get_label('cancel', 'Cancel')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="EditCommentModal" tabindex="-1" aria-labelledby="commentModalLabel"
            ...
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="commentModalLabel"><?php echo e(get_label('edit_comment', 'Edit Comment')); ?>
                    ...
                    <div class="modal-body">
                        <form id="comment-form" class="form-submit-event" method="POST"
                            enctype="multipart/form-data" action="<?php echo e(route('comments.update')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <button type="submit" id="submit_btn"
                                class="btn btn-primary"><?php echo e(get_label('update', 'Update')); ?></button>
                            <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal"><?php echo e(get_label('cancel', 'Cancel')); ?></button>
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="commentModalLabel">
                            <?php echo e(get_label('delete_comment', 'Delete Comment')); ?>
                    ...
                    <div class="modal-body">
                        <form id="delete-comment-form" class="form-submit-event" method="POST"
                            enctype="multipart/form-data" action="<?php echo e(route('comments.destroy')); ?>">
                            <?php echo method_field('Delete'); ?>
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal"><?php echo e(get_label('cancel', 'Cancel')); ?></button>
                        <button type="submit" id="submit_btn"
                            class="btn btn-danger"><?php echo e(get_label('delete', 'Delete')); ?></button>
                    </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="task-reply-modal" tabindex="-1" data-bs-backdrop="static"
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="replyForm" method="POST" enctype="multipart/form-data"
                            action="<?php echo e(route('tasks.comments.store', ['id' => $task->id])); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" id="parent_id" name="parent_id" value="">
                            ...
                            <div class="mb-3">
                                <label for="content" class="form-label"><?php echo e(get_label('reply', 'Reply')); ?></label>
                                <textarea id="task-reply-content" data-mention-type="task" data-mention-id="<?php echo e($task->id); ?>"
                                    name="content" rows="4" class="form-control" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="attachments"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="task_commentModalLabel">
                            <?php echo e(get_label('add_comment', 'Add Comment')); ?>
                    ...
                    <div class="modal-body">
                        <form id="comment-form" method="POST" enctype="multipart/form-data"
                            ...
                            <input type="hidden" name="parent_id" value="">
                            <div class="mb-3">
                                <textarea id="task-comment-content" data-mention-type="task" data-mention-id="<?php echo e($task->id); ?>"
        ...
        <div class="modal fade" id="TaskEditCommentModal" tabindex="-1" aria-labelledby="commentModalLabel"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="commentModalLabel">
                            <?php echo e(get_label('edit_comment', 'Edit Comment')); ?>
                    ...
                    <div class="modal-body">
                        <form id="comment-form" class="form-submit-event" method="POST"
                            enctype="multipart/form-data" action="<?php echo e(route('tasks.comments.update')); ?>">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="comment_id" id="comment_id" value="">
                            <div class="mb-3">
                                <textarea id="task-comment-edit-content" data-mention-type="task" data-mention-id="<?php echo e($task->id); ?>"
                                    name="content" rows="4" class="form-control"
                                    placeholder="<?php echo e(get_label('enter_comment', 'Enter Comment')); ?>" required></textarea>
                            </div>
                            <button type="submit" id="submit_btn"
        ...
        <div class="modal fade" id="TaskDeleteCommentModal" tabindex="-1" aria-labelledby="commentModalLabel"
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="delete-comment-form" class="form-submit-event" method="POST"
                            enctype="multipart/form-data" action="<?php echo e(route('tasks.comments.destroy')); ?>">
                            <?php echo method_field('Delete'); ?>
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="comment_id" id="delete_comment_id" value="">
                            <p><?php echo e(get_label('delete_alert', 'Are you sure you want to delete?')); ?></p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="uploadDocumentModalLabel">
                    <?php echo e(get_label('upload_document', 'Upload Document')); ?>
            ...
            <div class="modal-body">
                <form class="form-submit-event needs-validation" id="uploadDocumentForm"
                    action="<?php echo e(route('subscription-plan.upload-bank-transfer-document')); ?>" method="POST"
                    ...
                    <div class="alert alert-info mb-4">
                        <i class="bi bi-info-circle me-2"></i> <?php echo e($bank_transfer_settings['extra_notes'] ?? ''); ?>

                    </div>
                    <ul class="list-group mb-4">
                        <li class="list-group-item d-flex justify-content-between">
                            <span><b><?php echo e(get_label('bank_name', 'Bank Name')); ?>:</b></span>
                            <span><?php echo e($bank_transfer_settings['bank_name'] ?? ''); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span><b><?php echo e(get_label('bank_code', 'Bank Code')); ?>:</b></span>
                            <span><?php echo e($bank_transfer_settings['bank_code'] ?? ''); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span><b><?php echo e(get_label('account_name', 'Account Name')); ?>:</b></span>
                            <span><?php echo e($bank_transfer_settings['account_name'] ?? ''); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span><b><?php echo e(get_label('account_number', 'Account Number')); ?>:</b></span>
                            <span><?php echo e($bank_transfer_settings['account_number'] ?? ''); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span><b><?php echo e(get_label('swift_code', 'Swift Code')); ?>:</b></span>
                            <span><?php echo e($bank_transfer_settings['swift_code'] ?? ''); ?></span>
                        </li>
                    </ul>
                    <input type="hidden" name="subscription_id" id="subscription_id">
                    <div class="mb-4">
                        <label for="document"
                            class="form-label fw-bold"><?php echo e(get_label('choose_file', 'Choose File')); ?></label> <small
                            class="form-text"><?php echo e(get_label('supported_files_pdf_jpg_png_jpeg', 'Supported Files:JPG, PNG, JPEG')); ?></small>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" class="btn btn-secondary me-2"
                            data-bs-dismiss="modal"><?php echo e(get_label('cancel', 'Cancel')); ?></button>
                        <button type="submit" class="btn btn-primary"
                            id="submit_btn"><?php echo e(get_label('submit', 'Submit')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="viewDocumentsModal" tabindex="-1" aria-labelledby="documentModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="documentModalLabel"><?php echo e(get_label('documents', 'Documents')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <table class="table">
                    <thead>
                        <tr>
                            <th width="5%">#</th>
                            <th width="75%"><?php echo e(get_label('document', 'Document')); ?></th>
                            <th width="20%"><?php echo e(get_label('actions', 'Actions')); ?></th>
                        </tr>
                    </thead>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifyPaymentModalLabel">
                    <?php echo e(get_label('verify_payment', 'Verify Payment')); ?>
    ...
    'Are you sure you want to verify this
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success"
                    id="confirmVerifyPayment"><?php echo e(get_label('verify', 'Verify')); ?></button>
            </div>
        </div>
    </div>
</div>
    ...
    <?php if(isset($project)): ?>
        <div class="modal fade" id="createIssueModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e(get_label('create_issue', 'Create Issue')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="<?php echo e(route('issues.store', ['project' => $project->id])); ?>" class="form-submit-event"
                        method="POST">
                        <input type="hidden" name="dnr">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="mb-3">
                                    <label for="title" class="form-label"><?php echo e(get_label('title', 'Title')); ?>

                                        <span class="asterisk">*</span>
                                    </label>
                                    <input class="form-control" type="text" name="title"
                                        placeholder="<?php echo e(get_label('please_enter_title', 'Please enter title')); ?>">
                                    <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="description" rows="4"
                                        placeholder="<?php echo e(get_label('please_enter_description', 'Please enter description')); ?>"></textarea>
                                    <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label"
                                        for="assignee"><?php echo e(get_label('assign_to', 'Assign To')); ?></label>
                                    <select id="assignee" class="form-control js-example-basic-multiple"
                                        name="assignee_id[]"
                                        data-placeholder="<?php echo e(get_label('select_user', 'Select User')); ?>" multiple>
                                        <?php $__currentLoopData = $project->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>"
                                                <?php echo e(collect(old('assignee_id'))->contains($user->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label"
                                        for="status"><?php echo e(get_label('status', 'Status')); ?></label>
                                    <select class="form-control" name="status">
                                        <option value="open"><?php echo e(get_label('open', 'Open')); ?></option>
                                        <option value="in_progress"><?php echo e(get_label('in_progress', 'In Progress')); ?>

                                        </option>
                                        <option value="resolved"><?php echo e(get_label('resolved', 'Resolved')); ?></option>
                                        <option value="closed"><?php echo e(get_label('closed', 'Closed')); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="modal fade" id="editIssueModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?php echo e(get_label('update_issue', 'Update Issue')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="<?php echo e(route('issues.update', ['project' => $project->id])); ?>" class="form-submit-event"
                        method="POST">
                        <?php echo method_field('PUT'); ?>
                        <input type="hidden" name="dnr">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="issue_assignee" class="form-control js-example-basic-multiple" multiple
                                        name="assignee_id[]"
                                        data-placeholder="<?php echo e(get_label('select_user', 'Select User')); ?>">
                                        <?php $__currentLoopData = $project->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>">
                                                <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>
...
<?php if(Request::is($prefix . '/announcements')): ?>
    <div class="modal fade" id="create_announcement_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(get_label('create_announcement', 'Create Announcement')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="<?php echo e(route('announcements.store')); ?>" class="form-submit-event" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="content"
                                    class="form-label"><?php echo e(get_label('content', 'Content')); ?></label> <span
                                    class="asterisk">*</span>
                                <textarea class="form-control" name="content" rows="4"
                                    placeholder="<?php echo e(get_label('please_enter_content', 'Please Enter Content')); ?>"></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="start_date"
                                    class="form-label"><?php echo e(get_label('starts_at', 'Starts at')); ?></label>
                                <input type="text" id="start_date" name="start_date" class="form-control"
                                    value="" autocomplete="off">
                                <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="end_date"
                                    class="form-label"><?php echo e(get_label('ends_at', 'Ends at')); ?></label>
                                <input type="text" id="end_date" name="end_date" class="form-control"
                                    value="" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="priority" name="priority">
                                    <option value="low"><?php echo e(get_label('low', 'Low')); ?></option>
                                    <option value="medium"><?php echo e(get_label('medium', 'Medium')); ?></option>
                                    <option value="high"><?php echo e(get_label('high', 'High')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="form-label"><?php echo e(get_label('notify_users', 'Notify Users')); ?></label>
                                <span class="asterisk">*</span>
                                <div class="d-flex align-items-center mb-2">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label" for="all_workspace_users">
                                            <?php echo e(get_label('all_workspace_users', 'All Workspace Users')); ?>
                                ...
                                <div id="select_users_section" class="d-none mt-3">
                                    <label for="select_users"
                                        class="form-label"><?php echo e(get_label('select_users', 'Select Users')); ?></label>
                                    <select class="form-select js-example-basic-multiple" id="select_users"
                                        name="selected_users[]" multiple>
                                        <!-- Dynamically populate options -->
                                        <?php $__currentLoopData = $toSelectProjectUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>"><?php echo e(ucwords($user->first_name)); ?>

                                                <?php echo e(ucwords($user->last_name)); ?>
    ...
    <div class="modal fade" id="editAnnouncementModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(get_label('update_announcement', 'Update Announcement')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="<?php echo e(route('announcements.update')); ?>" class="form-submit-event" method="POST">
                    <?php echo method_field('PUT'); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-label-secondary">
                    <h5 class="modal-title w-100 text-center" id="announcementModalLabel">
                        ...
                        <?php echo e(get_label('announcement_details', 'Announcement Details')); ?>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="canEdit"
                        value="<?php echo e($auth_user->can('edit_announcements') ? true : false); ?>">
                    <input type="hidden" id="canDelete"
                        value="<?php echo e($auth_user->can('delete_announcements') ? true : false); ?>">
                    <input type="hidden" id="userId" value="<?php echo e($auth_user->id); ?>">
                    <input type="hidden" id="isAdminOrHasAllDataAccess"
                        value="<?php echo e(isAdminOrHasAllDataAccess()); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-between">
                                <small class="text-muted">
                                    <?php echo e(get_label('start_date', 'Start Date')); ?>:
                                    <span id="announcementStartDate" class="text-dark ms-1"></span>
                                </small>
                                <small class="text-muted">
                                    <?php echo e(get_label('end_date', 'End Date')); ?>:
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="text-muted mb-0"><?php echo e(get_label('priority', 'Priority')); ?></h6>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="text-muted mb-0"><?php echo e(get_label('created_by', 'Created By')); ?></h6>
...
<div class="modal fade" id="edit_task_list_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(get_label('update_task_list', 'Update Task List')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo e(route('task_lists.update')); ?>" class="form-submit-event" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <input type="hidden" name="dnr">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="project" class="form-label"><?php echo e(get_label('project', 'Project')); ?></label>
...
<div class="modal fade" id="create_task_list_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content form-submit-event" action="<?php echo e(route('task_lists.store')); ?>" method="POST">
            <input type="hidden" name="dnr">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(get_label('create_task_list', 'Create Task List')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <?php echo csrf_field(); ?>
            <div class="modal-body">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="project"
                            class="form-label"><?php echo e(get_label('select_project', 'Select Project')); ?></label> <span
                            class="asterisk">*</span>
                        <select class="form-select project-select" name="project_id">
                            <option value=""><?php echo e(get_label('select_project', 'Select Project')); ?></option>
                        </select>
...
<?php if(Request::is($prefix . '/custom-fields') || Request::is($prefix . '/settings/custom-fields')): ?>
     <!-- Custom Field Modal -->
    <div class="modal fade" id="add_field_modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form action="<?php echo e(route('custom_fields.store')); ?>" class="form-submit-event2 modal-content" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="module" class="form-label"><?php echo e(get_label('module', 'Module')); ?> <span class="text-danger">*</span></label>
                                <select class="form-select" id="module" name="module" required>
                                    <option value=""><?php echo e(get_label('select_module', 'Select module')); ?></option>
                                    <option value="project"><?php echo e(get_label('project', 'Project')); ?></option>
                                    <option value="task"><?php echo e(get_label('task', 'Task')); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="field_label" class="form-label"><?php echo e(get_label('field_label', 'Field Label')); ?><span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label"><?php echo e(get_label('is_required', 'Is Required')); ?></label>
                                <div class="d-flex gap-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="required" id="required_yes" value="1">
                                        <label class="form-check-label " for="required_yes"><?php echo e(get_label('yes', 'Yes')); ?></label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="required" id="required_no" value="0" checked>
                                        <label class="form-check-label" for="required_no"><?php echo e(get_label('no', 'No')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="field_type" class="form-label"><?php echo e(get_label('field_type', 'Field Type')); ?></label>
                                <select class="form-select" id="field_type" name="field_type">
                                    <option value="text"><?php echo e(get_label('text', 'Text')); ?></option>
                                    <option value="number"><?php echo e(get_label('number', 'Number')); ?></option>
                                    <option value="password"><?php echo e(get_label('password', 'Password')); ?></option>
                                    <option value="textarea"><?php echo e(get_label('textarea', 'Text Area')); ?></option>
                                    <option value="radio"><?php echo e(get_label('radio', 'Radio')); ?></option>
                                    <option value="date"><?php echo e(get_label('date', 'Date')); ?></option>
                                    <option value="checkbox"><?php echo e(get_label('checkbox', 'Check Box')); ?></option>
                                    <option value="select"><?php echo e(get_label('select', 'Select')); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-check form-check-lg">
                                ...
                                <label class="form-check-label" for="show_in_table">
                                    <?php echo e(get_label('show_in_table', 'Show In Table')); ?>
            ...
            <form id="edit_field_form" action="" method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_module" class="form-label"><?php echo e(get_label('module', 'Module')); ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_field_label" class="form-label"><?php echo e(get_label('field_label', 'Field Label')); ?><span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label " for="edit_required_yes"><?php echo e(get_label('yes', 'Yes')); ?></label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="required" id="edit_required_no" value="0" checked>
                                        <label class="form-check-label" for="edit_required_no"><?php echo e(get_label('no', 'No')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_field_type" class="form-label"><?php echo e(get_label('field_type', 'Field Type')); ?></label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="uploadAttachmentForm"
                      action="<?php echo e(route('candidate.upload', $candidates->id)); ?>"
                      class="form-submit-event"
...
<div class="modal fade" id="createTemplateModal" tabindex="-1" aria-labelledby="createTemplateLabel"
    ...
    <div class="modal-dialog modal-lg">
        <form class="modal-content form-submit-event" method="POST"
            action="<?php echo e(route('email.templates.store')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="dnr" />
            <input type="hidden" name="table" value="table " />
            <div class="modal-header">
                <h5 class="modal-title" id="createTemplateLabel">
                    <?php echo e(get_label('create_email_template', 'Create Email Template')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                    aria-label="<?php echo e(get_label('close', 'Close')); ?>"></button>
            </div>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="template-name"
                        class="form-label"><?php echo e(get_label('template_name', 'Template Name')); ?> <span
                            class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <label for="template-subject"
                        class="form-label"><?php echo e(get_label('email_subject', 'Email Subject')); ?> <span
                            class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <label for="template-body" class="form-label">
                        <?php echo e(get_label('email_body', 'Email Body')); ?> <span class="text-danger">*</span>
                    </label>
                    <div class="form-text text-dark alert alert-primary mb-2">
                        <?php echo e(get_label('placeholder_note', 'Note: You can use placeholders like')); ?>

                        <code><?php echo e('{name}'); ?></code>, <code><?php echo e('{email}'); ?></code>,
                        <code><?php echo e('{project_title}'); ?></code> etc. – these will be dynamically replaced when sending
                        the email.
                    </div>
                    <textarea name="content" id="template-body" class="form-control" rows="6" required>
                        <?php echo $__env->make('partials.default_email_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </textarea>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text alert alert-primary text-dark mb-2">
                            ...
                            <code><?php echo e('{project_title}'); ?></code>
                            <?php echo e(get_label('placeholder_hint', 'etc. – these will be dynamically replaced when sending the email.')); ?>

                        </div>

                        <textarea class="form-control" id="editBody" name="content" required><?php echo $__env->make('partials.default_email_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></textarea>
                    </div>
                </div>
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-header">
                <h5 class="modal-title text-primary">
                    ...
                    <?php echo e(get_label('email_preview', 'Email Preview')); ?>
                ...
                <div class="p-4">
                    <div id="previewContent" class="email-preview">
                        <div class="py-5 text-center">
                            ...
                            <p class="text-muted mt-3"><?php echo e(get_label('loading_preview', 'Loading preview...')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">
                    ...
                    <?php echo e(get_label('done', 'Done')); ?>
