...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
            ...
            <?php if(!$account_creation_template || ($account_creation_template && $account_creation_template->status == 1)): ?>
                <div class="alert alert-primary" role="alert">
                    <?php echo e(get_label('acc_crea_email_enabled_inf', 'As Account Creation Email Status Is Active, Please Ensure Email Settings Are Configured and Operational (Not Applicable If the Client Is for Internal Purposes).')); ?>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('clients.store')); ?>" method="POST" class="form-submit-event"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/clients/create_client.blade.php ENDPATH**/ ?>