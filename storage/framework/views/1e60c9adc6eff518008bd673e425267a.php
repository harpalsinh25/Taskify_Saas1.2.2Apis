    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb-2 mt-4">
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item">
                            <span><?php echo e(get_label('candidates', 'Candidates')); ?></span>
                        </li>
            ...
            <div>
                ...
                ?>
                <?php if($candidateDefaultView === 'list'): ?>
            ...
            <div>
                ...
                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#candidateModal">
                    <button type="button" class="btn btn-sm btn-primary action_create_template" data-bs-toggle="tooltip"
                        ...
                        data-bs-original-title="<?php echo e(get_label('create_candidate', 'Create Candidate')); ?>">
                        <i class='bx bx-plus'></i>
                    </button>
                </a>

                <a href="<?php echo e(route('candidate.kanban_view')); ?>"><button type="button" class="btn btn-sm btn-primary"
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive text-nowrap">
                    ...
                    <table id="table" data-toggle="table" data-url="<?php echo e(route('candidate.list')); ?>"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="id" data-sortable="true"
                                    ...
                                    <?php echo e(get_label('id', 'ID')); ?>

                                </th>
                                <th data-field="name" data-sortable="true"
                                    data-visible="<?php echo e(in_array('name', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>">
                                    <?php echo e(get_label('name', 'Name')); ?>

                                </th>
                                <th data-field="email"
                                    data-visible="<?php echo e(in_array('email', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>">
                                    <?php echo e(get_label('email', 'Email')); ?>
                                ...
                                <th data-field="phone" data-escap="false"
                                    ...
                                    <?php echo e(get_label('phone_number', 'Phone Number')); ?>

                                </th>
                                <th data-field="position" data-sortable="true"
                                    data-visible="<?php echo e(in_array('position', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>">
                                    <?php echo e(get_label('position', 'Position')); ?>

                                </th>
                                <th data-field="status" data-sortable="true"
                                    data-visible="<?php echo e(in_array('status', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>">
                                    <?php echo e(get_label('status', 'Status')); ?>
                                ...
                                <th data-field="source" data-sortable="true"
                                    ...
                                    <?php echo e(get_label('source', 'Source')); ?>

                                </th>
                                <th data-field="interviews" data-sortable="false">
                                    <?php echo e(get_label('interviews', 'Interviews')); ?>
...
<?php endif; ?>
        <?php endif; ?>
        <script src="<?php echo e(asset('assets/js/pages/candidate.js')); ?>"></script>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/candidate/index.blade.php ENDPATH**/ ?>