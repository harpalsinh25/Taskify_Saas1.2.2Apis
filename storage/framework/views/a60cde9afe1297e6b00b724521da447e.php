<div class="d-flex justify-content-between">
    <h5 class="card-title">
        <?php echo e(get_label('discussions', 'Discussions')); ?> : <?php echo e($project->title); ?>
...
<div id="comment-thread-container">
    <div class="comment-thread">
        <?php if(isset($project->comments) && $project->comments->isNotEmpty()): ?>
            <?php $__currentLoopData = $project->comments->whereNull('parent_id')->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(isset($project->comments) && $project->comments->count() > 5): ?>
...
<?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/components/discussions-card.blade.php ENDPATH**/ ?>