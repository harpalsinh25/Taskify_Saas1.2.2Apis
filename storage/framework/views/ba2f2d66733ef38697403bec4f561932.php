...
<div class="<?php echo e(Request::is($prefix . '/home') ? ' ' : 'card'); ?> empty-state text-center">
    <div class="card-body">
        <div class="misc-wrapper">
            <h2 class="mx-2 mb-2">
                <?php echo e(get_label(strtolower($type), $type) . ' ' . get_label('not_found', 'Not Found')); ?>

            </h2>
            <p class="mx-2 mb-4"><?php echo e(get_label('oops!', 'Oops!')); ?> 😖
                <?php echo e(get_label('data_does_not_exists', 'Data does not exists')); ?>.
            </p>

            <?php if(Request::is('*favorite*')): ?>
                <a class="btn btn-primary" href="<?php echo e(route('projects.index')); ?>">
                    <?php echo e(get_label('projects', 'Projects')); ?>
            ...
            <?php else: ?>
                ...
                <a class="btn btn-primary m-1"
                    href="<?php echo e(in_array($typeSlug, $javascriptVoidTypes) ? 'javascript:void(0)' : '/' . $prefix . (isset($link) && !empty($link) ? '/' . $link : '/' . $typeSlug . '/create')); ?>"
                    <?php if(isset($modalTargets[$typeSlug])): ?> data-bs-toggle="modal"
                data-bs-target="<?php echo e($modalTargets[$typeSlug]); ?>" <?php endif; ?>>
                    <?php echo e(get_label('create_now', 'Create now')); ?>
...
<?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\Code v1.2.1 upload this on server\resources\views/components/empty-state-card.blade.php ENDPATH**/ ?>