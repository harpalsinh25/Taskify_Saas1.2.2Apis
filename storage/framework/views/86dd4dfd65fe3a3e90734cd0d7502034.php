...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('clients.index')); ?>"><?= get_label('clients', 'Clients') ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a
                                href="<?php echo e(route('clients.profile', ['id' => $client->id])); ?>"><?php echo e($client->first_name . ' ' . $client->last_name); ?></a>
                        </li>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('clients.update', ['id' => $client->id])); ?>" method="POST" class="form-submit-event"
                    enctype="multipart/form-data">
                    <input type="hidden" name="redirect_url" value="<?php echo e(route('clients.index')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                      <div class="row">
                    <div class="mb-3 col-md-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="update_internal_client" name="internal_purpose" <?php echo e($client->internal_purpose==1?'checked':''); ?>>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="first_name" name="first_name" placeholder="<?= get_label('please_enter_first_name', 'Please enter first name') ?>" value="<?php echo e($client->first_name); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="last_name" class="form-label"><?= get_label('last_name', 'Last name') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" name="last_name" placeholder="<?= get_label('please_enter_last_name', 'Please enter last name') ?>" id="last_name" value="<?php echo e($client->last_name); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="email" class="form-label"><?= get_label('email', 'E-mail') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" id="email" name="email" placeholder="<?= get_label('please_enter_email', 'Please enter email') ?>" value="<?php echo e($client->email); ?>" autocomplete="off">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label class="form-label"><?= get_label('country_code_and_phone_number', 'Country code and phone number') ?></label>
                        <div class="input-group">
                               <input type="tel" class="form-control" id="phone-input-edit" value="<?php echo e($client->phone); ?>" name="phone">
                                    <input type="hidden" name="country_code" id="country_code" value="<?php echo e($client->country_code); ?>" >
                                    <input type="hidden" name="phone" id="phone_number">
                                    <input type="hidden" name="country_iso_code" id="country_iso_code" value="<?php echo e($client->country_iso_code); ?>">
                        </div>
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="company" class="form-label"><?= get_label('company', 'Company') ?></label>
                        <input class="form-control" type="text" id="company" name="company" placeholder="<?= get_label('please_enter_company_name', 'Please enter company name') ?>" value="<?php echo e($client->company); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="address" class="form-label"><?= get_label('address', 'Address') ?></label>
                        <input class="form-control" type="text" id="address" name="address" placeholder="<?= get_label('please_enter_address', 'Please enter address') ?>" value="<?php echo e($client->address); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="city" class="form-label"><?= get_label('city', 'City') ?></label>
                        <input class="form-control" type="text" id="city" name="city" placeholder="<?= get_label('please_enter_city', 'Please enter city') ?>" value="<?php echo e($client->city); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="state" class="form-label"><?= get_label('state', 'State') ?></label>
                        <input class="form-control" type="text" id="state" name="state" placeholder="<?= get_label('please_enter_state', 'Please enter state') ?>" value="<?php echo e($client->state); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="country" class="form-label"><?= get_label('country', 'Country') ?></label>
                        <input class="form-control" type="text" id="country" name="country" placeholder="<?= get_label('please_enter_country', 'Please enter country') ?>" value="<?php echo e($client->country); ?>">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="zip" class="form-label"><?= get_label('zip_code', 'Zip code') ?></label>
                        <input class="form-control" type="text" id="zip" name="zip" placeholder="<?= get_label('please_enter_zip_code', 'Please enter ZIP code') ?>" value="<?php echo e($client->zip); ?>">
                    </div>
                    <?php if(isAdminOrHasAllDataAccess()): ?>
                    <div class="mb-3 col-md-6 <?php echo e($client->internal_purpose==1?'d-none':''); ?> form-password-toggle" id="passDiv">
                        <label for="password" class="form-label">
                            <?= get_label('password', 'Password') ?>
                            <?php if($client->password !== null): ?>
                    ...
                    <div class="mb-3 col-md-6 <?php echo e($client->internal_purpose==1?'d-none':''); ?> form-password-toggle" id="confirmPassDiv">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <div class="d-flex align-items-start gap-4">
                            <img src="<?php echo e($client->photo ? asset('storage/' . $client->photo) : asset('storage/photos/no-image.jpg')); ?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                    ...
                    <?php if(isAdminOrHasAllDataAccess()): ?>
                    <div class="mb-3 col-md-6 <?php echo e($client->internal_purpose==1?'d-none':''); ?>" id="statusDiv">
                    ...
                    <?php if($client->email_verification_mail_sent==0 && empty($client->email_verified_at)): ?>

                    <div class="mb-3 col-md-6 <?php echo e($client->internal_purpose==1?'d-none':''); ?>" id="requireEvDiv">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dikshita\Desktop\Taskify-SaaS v1.2.1 - Project Mangement - Task Mangement  & Productivity Tool\saas\resources\views/clients/update_client.blade.php ENDPATH**/ ?>